...
-- ToDo list
local todo_list = require("todolist")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
	    ...
	    wibox.layout.margin(systray, 0, 0, 1, 0),
	    vert_sep,
            mytextclock,
	    vert_sep,
            s.mylayoutbox,
...
globalkeys = gears.table.join(
    ...
    awful.key({},"XF86AudioMute", function() awful.spawn.with_shell("pactl set-sink-mute 0 toggle") end,
    	      {description = "volume toggle", group = "audio control"}),
    
    -- Screenshots
    awful.key({ 		  }, "Print", function() awful.spawn.with_shell("screenshot") end,
              {description = "take full screenshot", group = "screenshots"}),
    awful.key({ modkey,    	  }, "Print", function() awful.spawn.with_shell("screenshot -s") end,
              {description = "select area to capture", group = "screenshots"}),
    awful.key({ modkey, "Shift"   }, "Print", function() awful.spawn.with_shell("screenshot -c") end,
              {description = "select area to copy to clipboard", group = "screenshots"}),
    awful.key({ modkey, "Control" }, "Print", function() awful.spawn.with_shell("screenshot -b") end,
              {description = "browse screenshots", group = "screenshots"}),
    awful.key({ modkey,		  }, "[", function() lock_show() end,
              {description = "lock the screen", group = "screen locker"}),
    awful.key({ modkey,	"Control" }, "]", function() todo_show() end,
              {description = "show todo list", group = "todo list"})
)
